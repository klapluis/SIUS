...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCcZKHGormEvzDbjfy4pkLdTPF_E5rgO6A'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "-3.9935676471081636, -79.20616566403197";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $ondragend					='getCoords(marker);';						// The JavaScript action to perform when the user stops dragging the map
